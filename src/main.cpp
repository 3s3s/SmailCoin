...
#if defined(NDEBUG)
# error "SmailCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "SmailCoin Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s SML additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    /////////////////////////////////////////////////////////////////////
    //KZV
    if (nHeight == 1) return 10000000 * COIN; //100% PREMAIN AT FIRST BLOCK
...
void ThreadScriptCheck() {
    RenameThread("smailcoin-scriptch");
