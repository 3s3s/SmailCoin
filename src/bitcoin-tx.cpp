...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("SmailCoin Core smailcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  smailcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded SmailCoin transaction") + "\n" +
              "  smailcoin-tx [options] -create [commands]   " + _("Create hex-encoded SmailCoin transaction") + "\n" +
              "\n";
